...
namespace Kexi.Common
{
    ...
    public class MapiMailMessage
    {
        ...
        public void ShowDialog()
        {
            ...
            var t = new Thread(new ThreadStart(_ShowMail)) {IsBackground = true};
        ...
        private static void _DeallocFiles(MAPIHelperInterop.MapiMessage message)
        {
        ...
        private IntPtr _AllocAttachments(out int fileCount)
        {
            ...
            var runptr = (long) ptra;
            foreach (var t in Files)
            {
                var path = t as string;
        ...
        /// </summary>
        private static void _LogErrorMapi(int errorCode)
        {
